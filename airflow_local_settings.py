...
from kubernetes.client.models.v1_pod import V1Pod as Pod
...
def pod_mutation_hook(pod: Pod):
  pod.annotations['airflow.apache.org/launched-by'] = 'hook'
  pod.annotations['airflow.apache.org/reason'] = 'some-job'
